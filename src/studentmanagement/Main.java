...
public class Main {
    ...
    public static void manage(Scanner sc) {
        ...
        loop: while (true) {
            ...
            switch (choose) {
                case ADD_STUDENR -> AddStudent(list, sc);
                case DELETE_STUDENR -> DeleteStudent(list, sc);
                case UPDATE_STUDENR -> ModifyStudent(list, sc);
                case QUERY_STUDENR -> QueryStudent(list);
                case EXIT_STUDENR -> {
